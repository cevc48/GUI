# revisão com colocação lado a lado da bússola e horizonte artificial
...
class IntegratedUAVGUI:
    def __init__(self, root):
        ...
        self.notebook = ttk.Notebook(main_frame,height=400,width=800,padding=(1,1,1,1),takefocus=True)
        ...
        self.wp_load_button.grid(row=0,column=1,sticky='n',padx=5)
